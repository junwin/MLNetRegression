...
namespace myApp
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            */
            // Train and Save the model
            HousePriceModel.TrainAndSaveModel(mlContext, _trainDataPath, _dataTransformModelPath, _modelPath);

            // Run a few test examples
            HouseData[] hd = new HouseData[] { housePriceSample1, housePriceSample2 };

            HousePricePrediction.PredictSinglePrice(hd, mlContext, _dataTransformModelPath, _modelPath);
